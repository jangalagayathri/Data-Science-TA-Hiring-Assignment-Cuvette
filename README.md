...
This repo contains my solutions for the Data Science TA Hiring Assignment. I’ve covered Python + ML, SQL, Tableau, Excel, and AI tool usage as outlined in the prompt.

## 🧠 Section 1: Python + Machine Learning

- Loaded and explored the StudentsPerformance.csv dataset.
- Engineered a binary target variable pass/fail based on average exam score.
